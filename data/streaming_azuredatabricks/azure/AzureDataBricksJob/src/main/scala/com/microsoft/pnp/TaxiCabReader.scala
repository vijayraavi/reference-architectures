...
import org.apache.spark.metrics.source.AppAccumulators
import org.apache.spark.metrics.source
import org.apache.spark.metrics.source.{AppMetrics, StaticAppMetrics}
    ...
    Try(parseArgs(args)) match {
      case Success(arguments) => {
       ...
       // metrics registry will log to ALA
        ...
        var processedInputCount = AppAccumulators.getProcessedInputCountInstance(spark.sparkContext)
